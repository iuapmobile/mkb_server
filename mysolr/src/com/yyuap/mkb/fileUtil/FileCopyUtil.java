...
public class FileCopyUtil {
    ...
    public static void copyDatas(String filePath, String filePath1) {
        ...
        try {
            ...
            MKBLogger.info("FileCopyUtil.java copyDatas() IOException: " + e.toString());
            ...
            try {
                ...
                MKBLogger.info("FileCopyUtil.java copyDatas() fis.close or fos.close IOException: " + e.toString());
            }
        }
    }

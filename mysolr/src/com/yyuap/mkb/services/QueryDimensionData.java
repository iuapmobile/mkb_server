 ...
 * 查询具体维度值
 */
@WebServlet("/QueryDimensionData")
public class QueryDimensionData extends HttpServlet {

	 /**
     * @see HttpServlet#HttpServlet()
     */
    public QueryDimensionData() {
        super();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
        	...
        	JSONArray array = qam.queryDimensionData(field, tenant);
            ro.setResponseKV("data", array);
